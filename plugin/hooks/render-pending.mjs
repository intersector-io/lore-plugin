...
export function renderDrainInstruction() {
  return [
    ...
    '     draining (or nothing is ready) — stop there. A non-zero exit saying another process',
    '     is writing the queue means the same thing and changed nothing — stop there too.',
