...
export declare const SEARCH_TOOLS: readonly ["search_knowledge", "list_records"];
/** Tools that fetch a specific record or its neighbourhood — a "read" in the usage series. */
export declare const READ_TOOLS: readonly ["get_record", "get_related"];
export type SearchTool = (typeof SEARCH_TOOLS)[number];
export type ReadTool = (typeof READ_TOOLS)[number];
export type KnowledgeTool = SearchTool | ReadTool;
/**
 ...
 */
export declare const RECORD_FETCH_TOOL: ReadTool;
